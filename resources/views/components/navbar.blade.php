  <!-- membuat navbar dengan method blade component -->
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <x-my-nav-link href="/" :current="request()->is('/')">Dashboard</x-my-nav-link>
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <!-- Profile dropdown 
            membuat jg untuk button ketika diklik isopen-->
            <div class="relative ml-3">
              <div>
                ...
                class="relative flex max-w-xs items-center rounded-full
                 bg-gray-800 text-sm focus:outline-hidden focus-visible:ring-2
                  focus-visible:ring-white focus-visible:ring-offset-2
                   focus-visible:ring-offset-gray-800 cursor-pointer" id="user-menu-button" aria-expanded="false" 
                   aria-haspopup="true">
                  <span class="absolute -inset-1.5"></span>
                  ...
                  <div class="ms-1 text-gray-300 text-sm font-medium ml-3">
                ...
                <span class="mx-2 text-sm text-white">|</span>
              ...
              <!--
                Dropdown menu, show/hide based on menu state.
                  ...
                  membuat agar tampilan ketika menu terbuka ya keliaan drop downnya
              -->
              <div x-show="isOpen" 
              ...
              class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <form action="/logout" method="POST">
                  @csrf
                <button type="submit" class="cursor-pointer block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2 ">
                  Log out
                </button>
                </form>
              </div>
    ...
    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3 flex flex-col">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        ...
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img class="size-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" 
            alt=" {{ Auth::user()->name }}" />
          </div>
          <div class="ml-3">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          <form action="/logout" method="POST">
            @csrf
            <button type="submit" class="w-full text-start cursor-pointer block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" role="menuitem" tabindex="-1" id="user-menu-item-2 ">
              Log out
            </button>
          </form>
        </div>
